...
// Defaults
private let defaultLogFormat = "[\(Logger.FormatPlaceholder.sourceName.rawValue)] \(Logger.FormatPlaceholder.level.rawValue) - \(Logger.FormatPlaceholder.value.rawValue)"
